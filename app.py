...
if st.button("Analisar Transcrição", type="primary"):
    if not transcript_text.strip():
        ...
        with st.spinner("Decupando... Analisando os tempos com a IA."):
            # Modelo atualizado para o Gemini 3 Flash
            ...
            COMO AVALIAR O TEXTO E OS TEMPOS (REGRAS ESTRITAS):
            ...
            2. RESPIROS E BURACOS (Crucial): NÃO junte ou mescle blocos de tempo só porque estão próximos! Se a frase A termina em 00:10 e a frase B começa em 00:12, mantenha-as como DOIS clipes separados no array JSON. Se você criar um clipe longo de 00:00 a 00:12, você estará incluindo os respiros inúteis. O corte tem que ser fragmentado e cirúrgico.
            3. Remova falas puramente vazias, "ééé", "hmmm" ou gagueiras.
            4. Identifique 3 tópicos principais do vídeo, além da "Limpeza Geral".
            
            Seu retorno DEVE ser EXATAMENTE um JSON neste formato, usando apenas os tempos literais que estão na transcrição original:
            {
                ...
                "limpeza_geral": {"title": "Apenas Cortes e Correções", "clips": [{"start": "00:00:00:00", "end": "00:00:10:00"}, {"start": "00:00:12:00", "end": "00:00:15:00"}]}
            }
